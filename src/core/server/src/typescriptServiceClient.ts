...
export default class TypeScriptServiceClient
        ...
        if (this.serverState.type === ServerState.Type.Running) {
          if (
            !this._configuration.implictProjectConfiguration.isEqualTo(
              oldConfiguration.implictProjectConfiguration
            )
          ) {
  ...
  public readonly onConfigDiagnosticsReceived = this
    ._onConfigDiagnosticsReceived.event;
  ...
  public readonly onDidBeginInstallTypings = this._onDidBeginInstallTypings
    .event;
  ...
  private serviceStarted(resendModels: boolean): void {
    ...
    const configureOptions: Proto.ConfigureRequestArguments = {
      ...
      preferences: {
        ...
        includePackageJsonAutoImports: this._configuration
  ...
  private serviceExited(restart: boolean): void {
    ...
    if (restart) {
      ...
      let prompt:
        | Thenable<undefined | vscode.MessageItem>
        | undefined = undefined;
