...
export default class LanguageProvider extends Disposable {
  ...
  private async registerProviders(): Promise<void> {
    ...
    await Promise.all([
      ...
      import(
        "./languageFeatures/codeLens/implementationsCodeLens"
      ).then((provider) =>
        this._register(
          provider.register(
            selector,
      ...
      import(
        "./languageFeatures/codeLens/referencesCodeLens"
      ).then((provider) =>
        this._register(
          provider.register(
            selector,
      ...
      import("./languageFeatures/jsDocCompletions").then((provider) =>
        this._register(
          provider.register(selector, this.description.id, this.client)
        )
      ),
